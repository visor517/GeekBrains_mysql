...
INSERT INTO `media_types` VALUES (1,'image'),(2,'video'),(3,'music'),(4,'document');
...
CREATE TABLE `users` (
  ...
  CONSTRAINT `phone_check` CHECK (((length(`phone`) = 11) and (not((`phone` like _utf8mb4'%[^0-9]%')))))
...
-- Dump completed on 2021-03-21 19:56:18
